...
```
# Presumably, because there are no non SQL-injectable questions that mention injectability, none of these people are asking for security advice. Perhaps this means that all of them know their code is secure.
